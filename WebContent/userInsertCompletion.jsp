  ...
  <ul class="clearfix" style="text-align:center ;">
    ...
    <li >
     ...
     <li >
		...
		<br/><h1><font color="white">お客様情報の登録が完了しました。</font></h1>
		<%
			User u = (User)session.getAttribute("userInfo"); //sessionからオブジェクトを取得
		%>
		<h2><%=u.getUsrName() %> &nbsp; 様のお客様IDは &nbsp; <font color="red"><%=u.getUsrId()%></font> &nbsp;でございます。</h2>
		<p1>ログインの際は<font color="red"> メールアドレス </font>が必要となります。</p1><br/>
		<p1>大切に保管してください。</p1><br/>
		<br/>
