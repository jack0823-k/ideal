  ...
  <ul class="clearfix" style="text-align:center ;">
    ...
    <li >
     ...
     <li >
		...
		<h2><%= reserve.getUsrName() %>様&emsp;ご予約取消</h2><br/>
		<%
			if(msg.length() > 0){
		%>
				<div><%= msg %></div>
		...
		<table border="2" align="center">
			...
			<tr>
				<th>日付</th>
				<td>
					<%= reserve.getRsvYy() %>年<%= reserve.getRsvMm() %>月<%= reserve.getRsvDd() %>日
				</td>
			</tr>
			<tr>
				<th>時刻</th>
				<td>
					<%= reserve.getRsvHh() %>時<%= reserve.getRsvMi() %>分
				</td>
			</tr>
			<tr>
				<th>人数</th>
