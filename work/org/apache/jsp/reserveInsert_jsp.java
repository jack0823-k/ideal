 ...
 * Generated at: 2020-11-06 23:38:09 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\tvar rsvDate = new Date(rsvYy, rsvMm, rsvDd, rsvHh, rsvMi, 0);\r\n");
      out.write("\t\t\tvar currentDate = new Date();\r\n");
      out.write("\t\t\tif(rsvDate.getTime() < currentDate.getTime()){\r\n");
      out.write("\t\t\t\tmsg += \"予約日時が過去の日時です。\\n\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif((rsvDate.getTime() - currentDate.getTime()) / 24 / 60 / 60 / 1000 >= 365){\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\trsvMm++;\r\n");
      out.write("\t\t\tif(((rsvYy % 4 == 0 && rsvYy % 100 != 0) || rsvYy % 400 == 0) && rsvMm == 2 && rsvDd >= 30){\r\n");
      out.write("\t\t\t\tmsg += \"予約日が存在しない日付です。29日までの日付を選択してください。\\n\";\r\n");
      out.write("\t\t\t}else if(rsvMm == 2 && rsvDd >= 29){\r\n");
      out.write("\t\t\t\tmsg += \"予約日が存在しない日付です。28日までの日付を選択してください。\\n\";\r\n");
      out.write("\t\t\t}else if((rsvMm == 4 || rsvMm == 6 || rsvMm == 9 || rsvMm == 11) && rsvDd == 31){\r\n");
      out.write("\t\t\t\tmsg += \"予約日が存在しない日付です。30日までの日付を選択してください。\\n\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(rsvHh == 21 && rsvMi != 0){\r\n");
      out.write("\t\t\t\tmsg += \"予約する時刻は17時00分から21時00分までの間で選択してください。\\n\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(msg.length > 0){\r\n");
      out.write("\t\t\t\talert(msg);\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      ...
      out.write("</h1>\r\n");
      out.write("\t<br />\r\n");
      out.write("\t<form id=\"frm1\" name=\"frm1\" action=\"ReserveOperationSvl\"\r\n");
      out.write("\t\tonSubmit=\"return checkData(this)\" method=\"post\">\r\n");
      out.write("\t\t<table border=\"1\" align=\"center\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<th>日付</th>\r\n");
      out.write("\t\t\t\t<td><select name=\"rsvYy\">\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</select> <select name=\"rsvMm\">\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</select> <select name=\"rsvDd\">\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<th>時刻</th>\r\n");
      out.write("\t\t\t\t<td><select name=\"rsvHh\">\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</select> <select name=\"rsvMi\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<th>人数</th>\r\n");
      out.write("\t\t\t\t<td><select name=\"person\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<th>コース</th>\r\n");
      out.write("\t\t\t\t<td><select name=\"courseId\">\r\n");
      ...
      out.write("\t\t\t\t席を確認します。確認を押してください。 <input\r\n");
      out.write("\t\t\t\t\ttype=\"submit\" value=\" 確認\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"usrId\" value=\"1\" />\r\n");
      out.write("\r\n");
