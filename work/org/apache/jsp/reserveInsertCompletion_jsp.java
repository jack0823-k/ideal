 ...
 * Generated at: 2020-11-08 12:59:26 UTC
...
public final class reserveInsertCompletion_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"completion.css\"/>\r\n");
      ...
      out.write("様、ご予約が完了いたしました。</h2>\r\n");
      out.write("\t\t<h2>\r\n");
      out.write("\t\t\t");
      out.print( request.getParameter("rsvYy") );
      out.write("年\r\n");
      out.write("\t\t\t");
      out.print( request.getParameter("rsvMm") );
      out.write("月\r\n");
      out.write("\t\t\t");
      out.print( request.getParameter("rsvDd") );
      out.write("日&ensp;\r\n");
      out.write("\t\t\t");
      out.print( request.getParameter("rsvHh") );
      out.write("時\r\n");
      out.write("\t\t\t");
      out.print( request.getParameter("rsvMi") );
      out.write("分より\r\n");
      out.write("\t\t</h2>\r\n");
      out.write("\t\t<!-- リクエストパラメータ等にコース名の情報が存在しないため、代わりにコースIDを表示します。→コース名を取得できるようにしました。 -->\r\n");
      out.write("\t\t<h2>コース名：");
      ...
      out.write("名様</h2>\r\n");
      out.write("\t\t<h2>ご予約番号は");
      out.print( request.getAttribute("rsvId") );
      out.write("番です。</h2>\r\n");
      out.write("\t\t<h2>ご来店の際、受付にお申し付けください。</h2>\r\n");
      out.write("\t\t<br/>\r\n");
      out.write("\r\n");
      out.write("<br />\r\n");
      out.write("\r\n");
